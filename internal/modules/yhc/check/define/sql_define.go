...
const (
	...
	SQL_QUERY_TABLESPACE        = `SELECT TABLESPACE_NAME, CONTENTS, STATUS, ALLOCATION_TYPE , TOTAL_BYTES - USER_BYTES AS USED_BYTES, TOTAL_BYTES AS TOTALBYTES
    ...
    'rdbms ipc reply',
    'smon timer');`
	SQL_QUERY_REPLICATION_STATUS = "select * from v$replication_status;"
